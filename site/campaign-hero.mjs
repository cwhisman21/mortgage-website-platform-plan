export function renderCampaignHero() {
  return `
    <section class="campaign-hero campaign-hero-image-only">
      <div class="campaign-hero-inner">
        <h1 class="visually-hidden">A better way to compare mortgage options</h1>
        <img class="campaign-hero-image" src="/site/assets/campaign-mortgage-machine.png" alt="There is a better way than hoping for the best. Compare mortgage options and start your comparison." />
